...
def choose_mode_window():
    ...
    # Title Label
    title_label = tk.Label(window, text="Choose Your Mode", font=label_font, fg="white", bg="#1e1e1e")
    ...
    single_player_shadow = tk.Button(frame, text="🧑‍💻", font=btn_font, bg="#0080FF", fg=btn_fg, 
    ...
    single_player_btn = tk.Button(frame, text="🧑‍💻", font=btn_font, bg=btn_bg, fg=btn_fg, 
                                  width=4, height=2, relief="solid", bd=2, 
    ...
    multiplayer_shadow = tk.Button(frame, text="👾", font=btn_font, bg="#0080FF", fg=btn_fg, 
                                   width=4, height=2, relief="solid", bd=2)
    multiplayer_shadow.grid(row=0, column=1, padx=shadow_offset, pady=shadow_offset)

    # Multiplayer Button (Main button)
    multiplayer_btn = tk.Button(frame, text="👾", font=btn_font, bg=btn_bg, fg=btn_fg, 
                                width=4, height=2, relief="solid", bd=2, 
                                borderwidth=4, highlightthickness=0)
